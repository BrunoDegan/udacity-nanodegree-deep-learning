...
class NeuralNetwork(object):       
    ...
    def forward_pass_train(self, X):
        ...
        return final_outputs,hidden_outputs # signals into final output layer

    def backpropagation(self, X, y, final_outputs, hidden_outputs ,delta_weights_i_h,delta_weights_h_o):
